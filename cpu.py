...
def cpu():
    filenamebefore = input('Enter cpubefore: ')
    filenameafter = input('Enter cpuafter: ')
    # read data
    ...
    df2 = df2.set_index('TIME')
        # 提取联机数据
    df1 = pd.DataFrame(df1['09.00.00': '17.00.00'])
    df2 = pd.DataFrame(df2['09.00.00': '17.00.00'])
    ...
    writer = pd.ExcelWriter('CPU.xlsx', engine='xlsxwriter', datetime_format='YYYY/MM/DD')
    ...
    dfpp1a2.to_excel(writer, sheet_name='PP1A',startrow = 35)
    dfpp1b2.to_excel(writer, sheet_name='PP1B',startrow = 35)
    dfpp1c2.to_excel(writer, sheet_name='PP1C',startrow = 35)
    dfpp1d2.to_excel(writer, sheet_name='PP1D',startrow = 35)
    dfpp1e2.to_excel(writer, sheet_name='PP1E',startrow = 35)
    dfpp1f2.to_excel(writer, sheet_name='PP1F',startrow = 35)
    dfpp1g2.to_excel(writer, sheet_name='PP1G',startrow = 35)
    dfpp1h2.to_excel(writer, sheet_name='PP1H',startrow = 35)
    ...
    chartpp1a.add_series({
        'categories': '=PP1A!$A$2:$A$34',
        'values': '=PP1A!$K$2:$K$34',
        'name': '=PP1A!$B$3',
    })
    chartpp1a.add_series({
        'values': '=PP1A!$K$37:$K$69',
        'name': '=PP1A!$B$37'
    })
    chartpp1a.set_y_axis({'num_format': '0.00%'})
    chartpp1a.set_legend({'position': 'bottom'})
    chartpp1a.set_title({'name': 'CPU%-PP1A'})
    ...
    chartpp1b.add_series({
        'categories': '=PP1B!$A$2:$A$34',
        'values': '=PP1B!$K$2:$K$34',
        'name': '=PP1B!$B$3',
    })
    chartpp1b.add_series({
        'values': '=PP1B!$K$37:$K$69',
         'name': '=PP1B!$B$37'
    })
    chartpp1b.set_y_axis({'num_format': '0.00%'})
    chartpp1b.set_legend({'position': 'bottom'})
    chartpp1b.set_title({'name': 'CPU%-PP1B'})
    # Insert the chart into the worksheet.
    ...
    chartpp1c.add_series({
        'categories': '=PP1C!$A$2:$A$34',
        'values': '=PP1C!$K$2:$K$34',
        'name': '=PP1C!$B$3',
    })
    chartpp1c.add_series({
        'values': '=PP1C!$K$37:$K$69',
        'name': '=PP1C!$B$37'
    })
    chartpp1c.set_y_axis({'num_format': '0.00%'})
    chartpp1c.set_legend({'position': 'bottom'})
    chartpp1c.set_title({'name': 'CPU%-PP1C'})
    # Insert the chart into the worksheet.
    ...
    chartpp1d.add_series({
        'categories': '=PP1D!$A$2:$A$34',
        'values': '=PP1D!$K$2:$K$34',
        'name': '=PP1D!$B$3',
    })
    chartpp1d.add_series({
        'values': '=PP1D!$K$37:$K$69',
        'name': '=PP1D!$B$37',
    })
    chartpp1d.set_y_axis({'num_format': '0.00%'})
    chartpp1d.set_legend({'position': 'bottom'})
    chartpp1d.set_title({'name': 'CPU%-PP1D'})
    # Insert the chart into the worksheet.
    ...
    chartpp1e.add_series({
        'categories': '=PP1E!$A$2:$A$34',
        'values': '=PP1E!$K$2:$K$34',
        'name': '=PP1E!$B$3',
    })
    chartpp1e.add_series({
        'values': '=PP1E!$K$37:$K$69',
        'name': '=PP1E!$B$37',
    })
    chartpp1e.set_y_axis({'num_format': '0.00%'})
    chartpp1e.set_legend({'position': 'bottom'})
    chartpp1e.set_title({'name': 'CPU%-PP1E'})
    # Insert the chart into the worksheet.
    ...
    chartpp1f.add_series({
        'categories': '=PP1F!$A$2:$A$34',
        'values': '=PP1F!$K$2:$K$34',
        'name': '=PP1F!$B$3',
    })
    chartpp1f.add_series({
        'values': '=PP1F!$K$37:$K$69',
        'name': '=PP1F!$B$37',
    })
    chartpp1f.set_y_axis({'num_format': '0.00%'})
    chartpp1f.set_legend({'position': 'bottom'})
    chartpp1f.set_title({'name': 'CPU%-PP1F'})
    # Insert the chart into the worksheet.
    ...
    chartpp1g.add_series({
        'categories': '=PP1G!$A$2:$A$34',
        'values': '=PP1G!$K$2:$K$34',
        'name': '=PP1G!$B$3',
    })
    chartpp1g.add_series({
        'values': '=PP1G!$K$37:$K$69',
        'name': '=PP1G!$B$37',
    })
    chartpp1g.set_y_axis({'num_format': '0.00%'})
    chartpp1g.set_legend({'position': 'bottom'})
    chartpp1g.set_title({'name': 'CPU%-PP1G'})
    # Insert the chart into the worksheet.
    ...
    chartpp1h.add_series({
        'categories': '=PP1H!$A$2:$A$34',
        'values': '=PP1H!$K$2:$K$34',
        'name': '=PP1H!$B$3',
    })
    chartpp1h.add_series({
        'values': '=PP1H!$K$37:$K$69',
        'name': '=PP1H!$B$37',
    })
    chartpp1h.set_y_axis({'num_format': '0.00%'})
    chartpp1h.set_legend({'position': 'bottom'})
    chartpp1h.set_title({'name': 'CPU%-PP1H'})
    # Insert the chart into the worksheet.
